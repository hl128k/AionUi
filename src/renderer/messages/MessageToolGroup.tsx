      ...
      {message.content.map((content) => {
        ...
        return (
          <Alert
            ...
            icon={isLoading && <LoadingOne theme='outline' size='12' fill='var(--theme-text)' className='loading lh-[1] flex' />}
            content={
              <div>
                ...
                <div className='text-12px text-[var(--theme-secondary-text)]'>{description}</div>
