...
const APP_STYLE_KEYS = ['o-logo', 'o-main', 'o-slider', 'o-workspace', 'o-slider-menu', 'o-setting-group', 'o-tips', 'o-message-right', 'o-message-left', 'o-diff-header', 'o-icon-color'] as const;
