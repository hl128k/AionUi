...
import { Card, Divider, Space, Tag, Typography } from '@/renderer/components/themed-components';
import { IconCode, IconMoonFill, IconSunFill } from '@icon-park/react';
...
const ThemeInfoCard: React.FC<{ theme: AppTheme; size: string }> = ({ theme, size }) => {
  ...
  return (
    <Card
      ...
      title={
        <Space>
          {theme.mode === 'light' ? <IconSunFill /> : <IconMoonFill />}
