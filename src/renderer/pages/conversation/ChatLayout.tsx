  ...
  return (
    <ThemedLayout className={'size-full'}>
      <ThemedLayout.Content>
        <ThemedLayout.Header className={'o-workspace flex items-center justify-between p-16px gap-16px h-56px'}>
        ...
        <ThemedLayout.Content className={'o-workspace h-[calc(100%-66px)]'}>{props.children}</ThemedLayout.Content>
      </ThemedLayout.Content>

      <ThemedLayout.Sider width={siderWidth} collapsedWidth={0} collapsed={rightSiderCollapsed} className={'o-workspace relative'}>
        {/* Drag handle */}
        ...
        {dragContext}
        <ThemedLayout.Header className={'flex items-center justify-start p-16px gap-16px h-56px'}>
        ...
        <ThemedLayout.Content className={'o-workspace h-[calc(100%-66px)]'}>{props.sider}</ThemedLayout.Content>
      </ThemedLayout.Sider>
    </ThemedLayout>
  );
};
